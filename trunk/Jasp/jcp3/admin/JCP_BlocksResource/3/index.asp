...
<form name="blockform" method="post" action="action.asp?action=createblock" style="margin:0;">
    <table width="100%" height="352" border="0" cellpadding="4" cellspacing="0">
      <tr> 
        ...
        <td colspan="2"><input type=text id=blockname name=blockname value="JS生成模块" onblur="IllegalCheck(this.value,this);BlankCheck(this.value,this);"> 
        </td>
      </tr>
      <tr> 
        <td height="29" align="right">模块说明：</td>
        <td colspan="2"><input type=text id=blockexplain name=blockexplain value="直接编写JS文件代码，以供多页面调用" onblur="IllegalCheck(this.value,this);BlankCheck(this.value,this);" style="width:100%;"></td>
      </tr>
      <tr> 
        <td height="265" colspan="3"><textarea name="blockcontent" id="blockcontent" style="width:100%;height:100%;">// JavaScript脚本代码

</textarea></td>
      </tr>
      <tr> 
        <td colspan="3" align="center">
		  <input type=hidden id=blocktype name=blocktype value="5"> 
