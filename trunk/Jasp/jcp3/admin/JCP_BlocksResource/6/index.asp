...
<form name="blockform" method="post" action="action.asp?action=createblock" style="margin:0;">
  <table width="100%" height="101" border="0" cellpadding="4" cellspacing="0">
    <tr> 
      ...
      <td colspan="2"><input type=text id=blockname name=blockname value="分页列表" onblur="IllegalCheck(this.value,this);BlankCheck(this.value,this);">
        </td>
    </tr>
    <tr> 
      <td height="29" align="right">模块说明：</td>
      <td colspan="2"><input type=text id=blockexplain name=blockexplain value="用于文章列表页，含分页信息设置" onblur="IllegalCheck(this.value,this);BlankCheck(this.value,this);" style="width:100%;"></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td colspan="2"><input type="radio" name="ClassFrom" id="ClassFrom" class="select" checked onclick="ClassStateSet(1);" value="1">
        来自模板 
        <input type="radio" name="ClassFrom" id="ClassFrom" class="select" onclick="ClassStateSet(2);" value="2" disabled>
          自定义 　
    ...
    <tr> 
      ...
      <td colspan="2"><textarea name="blockelement" id="blockelement" style="width:100%;height:60px;"><div><link target="_blank">标题 （时间）</div></textarea></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td colspan="2"><textarea name="blockpageinfo" id="blockpageinfo" style="width:100%;height:60px;"><div style="padding:10px;text-align:right;">{分页信息}</div></textarea></td>
    </tr>
    <tr> 
    ...
    <tr align="center"> 
        <td height="12" colspan="3"> <input type=hidden id=blocktype name=blocktype value="1">
