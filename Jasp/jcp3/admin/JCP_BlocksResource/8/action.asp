...
<%
dim rs,blockname,blocktype,blockexplain
dim discsign,needlink
dim blockfolder,blockeditfile,BlockAttribute,blockid

	blockname=request.Form("blockname")
	blocktype=request.Form("blocktype")
	blockexplain=request.Form("blockexplain")
	
	discsign=request.Form("discsign")
	needlink=request.Form("needlink")
	blockfolder=request.Form("blockfolder")
	blocktype=J.NumberYN(blocktype)
	
	BlockAttribute=discsign & "{$|}" & _	
				  needlink	
