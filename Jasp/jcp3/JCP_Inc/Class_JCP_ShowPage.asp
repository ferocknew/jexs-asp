<%
Class Class_ShowoPage
	Private Showo_PageSize,Showo_CurrPage
	Private Showo_Conn,Showo_DbType,Showo_RecType,Showo_RecSql,Showo_RecTerm,Showo_CookieName,Showo_Rs
	...
	'================================================================
	Public Sub ShowPage()%>
		<Script Language="JavaScript" type="text/JavaScript" src="<%=Showo_JsUrl%>show_page.js"></Script>
		<Script Language="JavaScript">
		ShowoPage("<div style='width:100%;height:30px;'><span style='float:left;margin-top:8px;'>","</span></div>","页次:<font color='red'>","</font>/","","&nbsp;","&nbsp;每页<font color='red'>","</font>条&nbsp;","&nbsp;共计:<font color='red'>","</font>条</span><span style='float:right;margin-top:4px;'>","<font face=webdings>9</font>","<font face=webdings>7</font>","<font face=webdings>8</font>","<font face=webdings>:</font>","&nbsp;&nbsp;跳转:","<font color='orange'>[","]</font>","","","<font color='red'>","</font>","","",<%=RecCount()%>,<%=Showo_PageSize%>,2)
		</Script>
	<%End Sub
